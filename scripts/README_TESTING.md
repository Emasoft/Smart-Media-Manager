...
**Usage**:
```bash
uv run python3 scripts/generate_all_format_commands.py
```
...
uv run python3 scripts/comprehensive_format_test.py

# Run complete pipeline with sample limit
uv run python3 scripts/comprehensive_format_test.py --max-samples 20

# Run individual steps
uv run python3 scripts/comprehensive_format_test.py --step 1  # Generate commands only
uv run python3 scripts/comprehensive_format_test.py --step 2  # Generate samples only
uv run python3 scripts/comprehensive_format_test.py --step 3  # Test samples only
uv run python3 scripts/comprehensive_format_test.py --step 4  # Analyze only
...
**Usage**:
```bash
uv run python3 scripts/analyze_test_results.py
```
...
**Usage**:
```bash
uv run python3 scripts/create_compatibility_sheet.py
```
...
**Usage**:
```bash
uv run python3 scripts/analyze_missing_formats.py
```
...
uv run python3 scripts/comprehensive_format_test.py --step 1

# Step 2: Generate samples (5-15 min)
uv run python3 scripts/comprehensive_format_test.py --step 2

# Step 3: Test samples (30-60 min)
uv run python3 scripts/comprehensive_format_test.py --step 3

# Step 4: Generate reports (fast)
uv run python3 scripts/comprehensive_format_test.py --step 4
```
